...
function formatTelegramMessage(eventType: string, payload: any): string {
  ...
  // Los datos vienen en payload.data (desde NestJS) o directamente en payload
...
• Mesa: ${data.table_id || "N/A"}
• Restaurante: ${data.restaurant_id || "N/A"}
• Fecha: ${data.reservation_date || "N/A"}
• Hora: ${data.reservation_time || "N/A"}
• Personas: ${data.number_of_guests || "N/A"}
...
🪑 Mesa ID: <code>${data.table_id || "N/A"}</code>
🏪 Restaurante: ${data.restaurant_id || "N/A"}
📋 Reserva: ${data.reservation_id || "N/A"}
